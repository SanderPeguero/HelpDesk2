...
function Cards({ data, handleOpenModal }) {
        ...
        <>
            {
                // eslint-disable-next-line react/prop-types
                data.map((card) => (
                    <button key={card.id} onClick={() => handleOpenModal(card)}>
                        <div className='flex flex-grow !flex-row border-0 px-3 py-3  bg-white rounded text-sm shadow hover:shadow-lg hover:cursor-pointer focus:outline-none focus:ring w-full ease-linear transition-all duration-150'>
