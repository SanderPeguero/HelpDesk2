    ...
    return (
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 flex flex-col w-[50vw]">
            ...
            <div className="-mx-3 md:flex mb-2 justify-between">
                ...
                <button className="mr-4 w-[9rem] py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md ring-gray-500 ring-offset-4  text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2  focus:ring-indigo-500">
                    Update Info
                </button>
                <button
                    onClick={submitUser}
